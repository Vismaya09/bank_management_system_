...
<?php 
  $array = $con->query("select * from branch_useraccounts_view");
  $row = $array->fetch_assoc();
 ?>
<div class="container">
<div class="card w-100 text-center shadowBlue">
  <div class="card-header">
    Account profile for <?php echo $row['name'];echo " ";echo "<kbd>";echo $row['accountNo'];echo "</kbd>"; ?>
  </div>
  <div class="card-body">
    <table class="table table-bordered">
      <tbody>
        <tr>
          ...
          <th><?php echo $row['balance'] ?></th></tr>
          <tr><td>Account Type</td>
          <th><?php echo $row['accountType'] ?></th>
        <td>Phone number</td>
          <th><?php echo $row['number'] ?></th></tr>
      </tbody>
    </table>
  </div>
