...
<body style="background-image: url(images/bankphoto.png);background-size: 100%">
<h1 class="alert alert-success rounded-0"><?php echo bankName; ?><small class="float-right text-muted" style="font-size: 12pt;">
<kbd>Presented by:VISMAYA AND CHARITHAA</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
    ...
    <div class="card-header" role="tab" id="headingOne">
      <h5 class="mb-0">
        <a style="text-decoration: none;" data-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
         <button class="btn btn-outline-success btn-block"><i>User Login</i></button>
        </a>
      </h5>
    </div>
